...
export abstract class IMutation {
  ...
  abstract localSignout(
    input: LocalSignoutInput,
  ): Credential | Promise<Credential>;

  abstract createCredential(
    input: CreateCredentialInput,
  ): Nullable<Credential> | Promise<Nullable<Credential>>;
  ...
  ): Nullable<Permission> | Promise<Nullable<Permission>>;

  abstract deleteCredentials(
    input?: Nullable<DeleteMultipleItemsInput>,
  ): Nullable<BulkOperationResult> | Promise<Nullable<BulkOperationResult>>;
  ...
  abstract deletePermissions(
    input?: Nullable<DeleteMultipleItemsInput>,
  ): Nullable<BulkOperationResult> | Promise<Nullable<BulkOperationResult>>;

  abstract createProject(
    input: CreateProjectInput,
  ): Nullable<Project> | Promise<Nullable<Project>>;
  ...
  ): Nullable<Task> | Promise<Nullable<Task>>;
...
export abstract class IQuery {
  ...
  abstract credentials(
    input?: Nullable<CredentialWhereUniqueInput>,
  ):
    | Nullable<Nullable<Credential>[]>
    | Promise<Nullable<Nullable<Credential>[]>>;
  ...
  abstract projects(
    input?: Nullable<GetProjectsInput>,
  ): Nullable<Nullable<Project>[]> | Promise<Nullable<Nullable<Project>[]>>;
  ...
  abstract tasks(
    input?: Nullable<GetTasksInput>,
  ): Nullable<Nullable<Task>[]> | Promise<Nullable<Nullable<Task>[]>>;
